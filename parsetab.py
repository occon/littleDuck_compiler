...
_lr_productions = [
  ...
  ('Expresion -> Expresion GREATERTHAN Exp','Expresion',3,'p_expresion','littleDuck_parser.py',108),
  ('Expresion -> Expresion LESSTHAN Exp','Expresion',3,'p_expresion','littleDuck_parser.py',109),
  ('Expresion -> Expresion NOTEQUAL Exp','Expresion',3,'p_expresion','littleDuck_parser.py',110),
